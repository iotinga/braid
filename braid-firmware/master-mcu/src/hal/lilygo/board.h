...
#define I2C_SDA CONFIG_ATCA_I2C_SDA_PIN
#define I2C_SCL CONFIG_ATCA_I2C_SCL_PIN

#define BUTTON_COUNT (1)
#define USER_BUTTON  _PIN(0)
#define BUTTON_ARRAY {USER_BUTTON_PIN}
...
#elif defined(LILYGO_ESP32_SIM7000G)

#define USING_MODEM

#define BOARD_MODEM_PWR_PIN PIN(4)
#define BOARD_MODEM_DTR_PIN PIN(25)
#define BOARD_MODEM_RXD_PIN PIN(26)
#define BOARD_MODEM_TXD_PIN PIN(27)

#define I2C_SDA PIN(CONFIG_ATCA_I2C_SDA_PIN)
#define I2C_SCL PIN(CONFIG_ATCA_I2C_SCL_PIN)
